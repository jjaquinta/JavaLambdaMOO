...
public class NetworkAPITest extends MinimalDBBase
{
    ...
    public void testConnectedPlayers() throws MOOException
    {
        ...
        MOOValue connected1 = MOOScriptLogic.executeScript("connected_players(true);");
        Assert.assertTrue("Should return List", connected1 instanceof MOOList);
        Assert.assertEquals("Should be no one connected", 0, ((MOOList)connected1).size());
        conn.startConnection();
        conn.write("xyzzy");
        conn.read();
        MOOValue connected2 = MOOScriptLogic.executeScript("connected_players(true);");
        Assert.assertTrue("Should return List", connected2 instanceof MOOList);
        Assert.assertEquals("Should be one connected", 1, ((MOOList)connected2).size());
    }
    @Test
    public void testConnectedSeconds() throws MOOException
    {
        ...
        MOOValue connected = MOOScriptLogic.executeScript("connected_seconds(#3);");
    ...
    public void testIdleSeconds() throws MOOException
    {
        ...
        MOOValue connected = MOOScriptLogic.executeScript("idle_seconds(#3);");
        Assert.assertTrue("Should return Number", connected instanceof MOONumber);
    ...
    public void testNotify() throws MOOException
    {
        ...
        conn.write("xyzzy");
        conn.read();
        MOOScriptLogic.executeScript("notify(#3, 'hello', true);");
    ...
    public void testOutputDelimiters() throws MOOException
    {
        ...
        conn.write("xyzzy");
        conn.read();
        MOOValue ret = MOOScriptLogic.executeScript("output_delimiters(#3);");
        ...
        Assert.assertEquals("Item 1 should be prefix", "xyzzy", ((MOOString)((MOOList)ret).get(0)).getValue());
        Assert.assertTrue("Item 2 should be string", ((MOOList)ret).get(0) instanceof MOOString);
        Assert.assertEquals("Item 2 should be suffix", "xyzzy", ((MOOString)((MOOList)ret).get(0)).getValue());
    }
    @Test
    public void testBootPlayer() throws MOOException
    {
        ...
        MOOScriptLogic.executeScript("boot_player(#3);");
        try
        {
            Thread.sleep(500);
        }
        ...
        Assert.assertEquals("Should be no one connected", 0, connected2.size());
    }
    @Test
    public void testSetConnectionOption() throws MOOException
    {
        ...
        conn.write("xyzzy");
        conn.read();
        MOOScriptLogic.executeScript("set_connection_option(#3, 'wibble', 'wobble');");
    ...
    public void testConnectionOptions() throws MOOException
    {
        ...
        MOOValue ret = MOOScriptLogic.executeScript("connection_options(#3);");
        Assert.assertTrue("Should return List", ret instanceof MOOList);
        ...
        Assert.assertEquals("Contained list should have two items", 2, ((MOOList)first).size());
        MOOValue firstKey = ((MOOList)first).get(0);
        ...
        MOOValue firstVal = ((MOOList)first).get(1);
    ...
    public void testConnectionOption() throws MOOException
    {
        ...
        conn.read();
        MOONetworkAPI.set_connection_option(new MOOObjRef(3), new MOOString("wibble"), new MOOString("wobble"));
        MOOValue ret = MOOScriptLogic.executeScript("connection_option(#3, 'wibble');");
        Assert.assertTrue("Should return String", ret instanceof MOOString);
    ...
    public void testListen() throws MOOException
    {
        TestConnectionHandler conn = new TestConnectionHandler();
        MOOConnectionLogic.addConnectionHandler(conn);
        MOOScriptLogic.executeScript("listen(#0, 'test://1', true);");
        conn.startConnection();
        conn.write("xyzzy");
    ...
    public void testunlisten() throws MOOException
    {
        ...
        MOOConnectionLogic.addConnectionHandler(conn);
        MOONetworkAPI.listen(new MOOObjRef(0), new MOOString("test://1"), MOONumber.TRUE);
        MOOScriptLogic.executeScript("unlisten(1);");
        try
        {
            Thread.sleep(500);
        }
        ...
        Assert.assertEquals("Unexpected listener", 0, listeners.size());
    }
    @Test
    public void testListeners() throws MOOException
    {
        ...
        MOOConnectionLogic.addConnectionHandler(conn);
        MOONetworkAPI.listen(new MOOObjRef(0), new MOOString("test://1"), MOONumber.TRUE);
        MOOValue ret = MOOScriptLogic.executeScript("listeners();");
        Assert.assertTrue("Should return List", ret instanceof MOOList);
        Assert.assertEquals("Should be single item in list", 1, ((MOOList)ret).size());
        MOOValue first = ((MOOList)ret).get(0);
        Assert.assertTrue("Should contain a list", first instanceof MOOList);
        Assert.assertEquals("Contained list should have three items", 3, ((MOOList)first).size());
        MOOValue firstHandler = ((MOOList)first).get(0);
        ...
        MOOValue firstCanon = ((MOOList)first).get(1);
        ...
        MOOValue firstPrint = ((MOOList)first).get(2);
